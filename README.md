...
```shell
git clone https://github.com/egt495/hugoThemes
```
...
5) Build a local version of your site by executing `hugo server`. You can see the site by navigating to `http://localhost:1313/hugoThemes/` (actual URL will be outputted in the CLI) in a browser.
...
`hugo.yaml`:
```yaml
baseURL: 'https://egt495.github.io/hugoThemes'
title: 'Qubt Theme'
```
...
links:
  - github: https://github.com/egt495/hugoThemes
  - link: https://github.com/egt495/hugoThemes#readme
...
`https://egt495.github.io/hugoThemes`